...
from htp_docking import docking_openeye
from dock_filt import *
...
if __name__ == "__main__":
    ...
    if args.method == "mcf":
        filterer = partial(filter_dock, receptor_oedu_file = args.rec, n_jobs=208)
    else:
